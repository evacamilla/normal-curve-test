    ...
    return(
        <div>
            ...
            <ul>
                ...
                <li><NavLink onClick={(event) => {props.toggleMenu(); props.changeChapter("Frågorna");}} activeClassName="linkIsActive" exact={true} to="/fyllidinasvar">Fyll i dina svar</NavLink></li> 
